...
#    ('A7', 0.074 * m_to_pt, 0.105 * m_to_pt),
	...
	('B4 (ISO)', 0.353 * m_to_pt, 0.250 * m_to_pt),
	('B5 (ISO)', 0.250 * m_to_pt, 0.176 * m_to_pt),
	('C3', 0.458 * m_to_pt, 0.324 * m_to_pt),
	('C4', 0.324 * m_to_pt, 0.229 * m_to_pt),
	('C5', 0.229 * m_to_pt, 0.162 * m_to_pt),
	('C6', 0.162 * m_to_pt, 0.114 * m_to_pt),
