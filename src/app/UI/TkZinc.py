...
#
# $Id: Zinc.py.in,v 1.13 2005/10/05 17:54:29 vidon Exp $
#
#
...
if nok : return 0 '''
	...
	try:
		...
		sversion = window.tk.call( 'zinc' ) + " TkZinc.py %s" % __version__
...
# 			#à {} 
		...
		if master:
			...
			master.pack()
			self.version = havetkzinc( master )
		Tkinter.Widget.__init__( self, master, 'zinc', cnf, kw )
# 		self.items = {}
# 		#BootStrap Root
# 		classe = eval( 'Group' )
# 		obj = None
...
# 		self.items[1] = obj
	...
	def __oldconfigure( self, **kw ):
		return Tkinter.Widget.configure( self, **kw )
 	...
 	def configure( self, **kw ):
 		...
 		"""
		res  = Tkinter.Widget.configure( self, **kw )
 		dico = {}
		if res:
