...
#This call destroyes all bindings to ttk widgets so we delete it from TButton <ButtonPress-1>
#ttk::clickToFocus %W; 
bind TButton <ButtonRelease-1> { %W instate {pressed !disabled} { %W state !pressed; %W invoke} }
bind TButton <Button1-Leave>    { %W state !pressed; %W state !active }
bind TButton <Button1-Enter>    { %W instate {active !disabled} { %W state pressed } }
