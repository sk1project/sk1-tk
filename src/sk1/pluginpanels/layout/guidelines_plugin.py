...
from sk1.tkext import UpdatedButton, UpdatedListbox
...
class GuidelinesPanel(PluginPanel):
	...
	def init(self, master):
		...
		optmenu = create_unit_menu(pos_frame, self.set_unit, variable = var_unit, width = 3)
		optmenu.pack(side = RIGHT, expand = 0, anchor = W)
