#-----------------------------------------------------------------------
# DESCRIPTION:
#     To be used with the xt, xaw, xm, and glx modules. These "defines"
#     have been taken from the /usr/include/X11/X.h file.
#
...
#
# Don't define None, in fear for "from X import *" overriding Python's None
