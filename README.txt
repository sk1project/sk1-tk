...
THIS REPOSITORY CONTAINS OUTDATED sK1 0.9.x BRANCH (Tcl/Tk).
Actual sK1 2.0 is under active development using wxWidgets and the source
code is placed in sk1project/sk1-wx repository.
