# ------------------------------------Button----------------------------------------------------
        ...
        style element create button image [list $K(button) \
				...
				{active !disabled !focus}  $K(button_active) \
	...
	#----------------------
        ...
        style element create Pal2TopButton.button image [list $K(pal_botton_normal) \
				{pressed !disabled} $K(pal_botton_pressed) \
				{active !disabled}  $K(pal_botton_active) ] \
	...
	#----------------------
        ...
        style element create PalTopButton.button image [list $K(pal_botton_normal) \
				{pressed !disabled} $K(pal_botton_pressed) \
				{active !disabled}  $K(pal_botton_active) ] \
				-border {3 3 3 3} -padding {3 3 3 3} -sticky news
	...
	#----------------------
        ...
        style element create PalBottomButton.button image [list $K(pal_botton_normal) \
				{pressed !disabled} $K(pal_botton_pressed) \
				{active !disabled}  $K(pal_botton_active) ] \
				-border {3 3 3 3} -padding {3 3 3 3} -sticky news 
	...
	#----------------------
        ...
        style element create Pal2BottomButton.button image [list $K(pal_botton_normal) \
				{pressed !disabled} $K(pal_botton_pressed) \
				{active !disabled}  $K(pal_botton_active) ] \
				-border {3 3 3 3} -padding {3 3 3 3} -sticky news 
...
# ---------------------------------------------------------------------------------------------------
        ...
        style element create TSmallbutton.button image [list $K(clear15) \
